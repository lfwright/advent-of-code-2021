...
if __name__ == "__main__":
    ...
    print(instructions_data[0])
    
    thermal_array = load_points_into_array(points_data)
    thermal_array = perform_folds_on_array(thermal_array, [instructions_data[0]])

    number_of_points_visible = count_ones_in_array(thermal_array)
    
    
    print(thermal_array)
    print("the number of points visible is: ", number_of_points_visible)
